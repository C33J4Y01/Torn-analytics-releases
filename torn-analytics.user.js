...
(() => {
  ...
  function automaticLogSyncStatusText(
    ...
    return (
      `Last update ${lastUpdate} Â· checks after 30 minutes`
    );
  }
  ...
  async function loadTrainingSupplySnapshot(
    ...
    tracker?.setStage(
      'Refreshing Happy Jump suppliesâ€¦',
    ...
    if (snapshot?.status === 'available') {
      ...
      return {
        ...
        summary: missingUnits > 0
          ...
          : 'Jump items ready',
        note: 'Personal inventory only Â· Torn may cache counts for up to 1 hour.',
        supplies
      };
    }
